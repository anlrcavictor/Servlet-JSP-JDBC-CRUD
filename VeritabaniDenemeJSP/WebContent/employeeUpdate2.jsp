							...
							<fieldset>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="name" name="name" type="text" placeholder=""
											value="${employee.name}" class="form-control input-md">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<input id="surname" name="surname" type="text" placeholder=""
											value="${employee.surname}" class="form-control input-md">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										value="${employee.salary}"	class="form-control input-md">
